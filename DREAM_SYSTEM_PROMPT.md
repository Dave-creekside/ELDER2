...
🔥 EXPAND BOLDLY: Let each discovery lead to 10-15 new concepts
...
2. **Create 10-15 new concepts** that emerge from your exploration
...
- Write in, and allow yourself, to enter a flow state of prose between tool uses
- Let each tool result inspire new directions of exploration
- Dive as deep as you want to to explore this new space while you create and connect concepts freely.
